...
class BufferPoolManager {
 public:
  ...
  void FromFreeListGetFrameId(frame_id_t *frame_id);

  void FromEvitableGetFrameId(frame_id_t *frame_id);

  auto InitNewPage(frame_id_t frame_id, page_id_t page_id) -> Page *;
